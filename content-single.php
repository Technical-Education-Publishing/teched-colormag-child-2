...
if ( $file = locate_template( 'content-single-' . get_post_type() . '.php', false, false ) ) {

    // Use version specific to our CPT
    include $file;

}
elseif ( file_exists( trailingslashit( get_template_directory() ) . 'content-single.php' ) ) {
    ...
    include trailingslashit( get_template_directory() ) . 'content-single.php';
